...
# --- 1. Backbone ---
def get_backbone(model_name='resnet50', freeze=True):
    if model_name == 'resnet50':
        ...
        backbone.classifier = nn.Identity()  # remove entire classifier
...
class ORNN(nn.Module):
    def __init__(self, num_classes=4, backbone_name='resnet50'):
        super().__init__()
        self.backbone, feature_dim = get_backbone(backbone_name)
        K = num_classes - 1
